...
- **生活助手**：
  ...
  - **寻物模式**：通过手机内置雷达和摄像头寻找物品（需要用户提前拍下并保存该物品的照片，拍照时背景应尽可能干净整洁以凸显目标物品）（需要开启摄像头权限和存储权限）
...
| :----------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------: |
| <a href="https://pineapplesnowy.cn/phone"> <img src="readme_files/feature_identify.jpg"  width="100%"> </a> | <a href="https://pineapplesnowy.cn/phone"> <img src="readme_files/feature_locate.jpg" width="100%"> </a> |
