...
pic_path_1 = os.path.join(module_dir, 'template1.jpg')
pic_path_2 = os.path.join(module_dir, 'template2.jpg')
pic_path_3 = os.path.join(module_dir, 'template3.jpg')
pic_path_4 = os.path.join(module_dir, 'template4.jpg')
pic_path_5 = os.path.join(module_dir, 'template5.jpg')
